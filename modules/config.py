...
INDUSTRY_TYPES = [
    ...
    ("ecommerce_construction_tools",  "أدوات بناء وعدد أونلاين"),
    ("ecommerce_food",                "طلبات طعام وتوصيل"),
    ("ecommerce_sweets",              "حلويات ومعجنات أونلاين"),
    ("ecommerce_health_beauty",       "صحة وجمال أونلاين"),
    ("ecommerce_cosmetics",           "مستحضرات تجميل أونلاين"),
    ("ecommerce_perfumes",            "عطور وبخور أونلاين"),
    ("ecommerce_jewelry_gold",        "ذهب ومجوهرات أونلاين"),
    ("ecommerce_chains",              "سلاسل وإكسسوارات فاخرة أونلاين"),
    ("ecommerce_accessories",         "إكسسوارات متنوعة أونلاين"),
    ("ecommerce_bags",                "حقائب وإكسسوارات أونلاين"),
    ("ecommerce_watches",             "ساعات وإكسسوارات أونلاين"),
    ("ecommerce_home_furniture",      "أثاث منزلي أونلاين"),
    ("ecommerce_office_furniture",    "أثاث مكتبي أونلاين"),
    ("ecommerce_home_decor",          "أثاث وديكور أونلاين"),
    ("ecommerce_kitchen_tools",       "أدوات مطبخ ولوازم منزلية أونلاين"),
    ("ecommerce_baby_products",       "مستلزمات أطفال ورضع أونلاين"),
    ("ecommerce_sports",              "معدات رياضية أونلاين"),
    ("ecommerce_auto_accessories",    "إكسسوارات سيارات أونلاين"),
...
SIDEBAR_CONFIG = {
    "_common": [
        ...
        {"key": "notifications", "label": "الإشعارات",     "label_en": "Notifications",      "icon": "🔔", "url": "/notifications"},
