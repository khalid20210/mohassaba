...
SIDEBAR_CONFIG = {
    "_common": [
        ...
        {"key": "workforce",        "label": "الموظفون والمناديب", "icon": "🧑‍💼", "url": "/workforce"},        {"key": "owner",            "label": "قمرة القيادة",       "icon": "👑", "url": "/owner/"},        {"key": "accounting",       "label": "المحاسبة",           "icon": "📒", "url": "/accounting"},
