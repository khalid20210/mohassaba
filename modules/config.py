...
SIDEBAR_CONFIG = {
    "_common": [
        ...
        {"key": "workforce",        "label": "الموظفون والمناديب", "icon": "🧑‍💼", "url": "/workforce"},        {"key": "team",             "label": "إدارة الفريق",       "icon": "👥", "url": "/team"},        {"key": "owner",            "label": "قمرة القيادة",       "icon": "👑", "url": "/owner/"},        {"key": "accounting",       "label": "المحاسبة",           "icon": "📒", "url": "/accounting"},
        {"key": "purchase-import",  "label": "استيراد فاتورة",    "icon": "📥", "url": "/purchase-import"},
        {"key": "audit-log",       "label": "سجل العمليات",    "icon": "🗂️", "url": "/audit-log"},
